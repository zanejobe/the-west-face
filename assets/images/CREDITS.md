...
|---|---|---|---|
| `1948-king-pp215.png` | TBD (likely USGS PP 215 figure / plate) | TBD — confirm USGS public domain vs scan rights | Wired to `king-1948-pp215` (cover-style); also front-page hero. |
...
| `2025-banner-west-face.jpg` | Derived from `originals/2025-11-13-west-face-escarpment.jpeg` | Zane Jobe; all rights reserved unless noted | Brushy TimelineJS title background (~249 KB, 2000×649). |
...
| `originals/2025-11-13-west-face-escarpment.jpeg` | Zane Jobe (iPhone, 2025-11-13) | All rights reserved unless noted | Full-res (~16 MB). |
